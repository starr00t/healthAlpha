  ...
  const helpSections = [
    ...
    },
    {
      ...
      content: [
        {
          subtitle: '캘린더 기능',
          text: '날짜별로 건강 기록과 일정을 한눈에 확인하고 관리할 수 있습니다.',
        },
        {
          subtitle: '사용 방법',
          items: [
            '📆 월간 캘린더: 날짜별 기록 현황 확인',
            '📝 일정 추가: 병원 예약, 운동 계획 등 등록',
            '🔍 날짜 클릭: 해당 날짜의 상세 기록 보기',
            '✏️ 기록 편집: 과거 데이터 수정 및 삭제',
            '🏥 일정 관리: 건강 관련 일정 추가/삭제',
          ],
        },
        {
          subtitle: '색상 표시',
          items: [
            '🟢 녹색 점: 해당 날짜에 건강 기록 존재',
            '🔵 파란색 점: 일정이 있는 날',
            '🟠 주황색 점: 기록과 일정 모두 있는 날',
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      content: [
        {
          subtitle: '개인 정보 설정',
          text: '건강 프로필을 등록하여 맞춤형 분석과 조언을 받을 수 있습니다.',
        },
        {
          subtitle: '기본 정보',
          items: [
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 dark:text-blue-300">"프로필" 탭에서 기본 정보와 건강 정보를 입력하세요</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
